...
/**
 * Socket.IO client source and version, loaded dynamically
 * if serveClient enabled.
 */
var clientSource = null;
...
Server.prototype.serve = function(req, res){
  clientVersion = clientVersion || require('socket.io-client/package').version;
  clientSource = (clientSource || read(require.resolve(
      'socket.io-client/socket.io.js'), 'utf-8'));
